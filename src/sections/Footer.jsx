      ...
      <div className="container">
        ...
        <ul className="navbar-nav menu">
          <li className="nav-item menu__li">
            <Link to="/" className="nav-link menu__link link-hover">
              Каталог
            </Link>
          </li>
          <li className="nav-item menu__li">
            <Link to="/about-us" className="nav-link menu__link link-hover">
              Про нас
            </Link>
          </li>
          <li className="nav-item menu__li">
            <Link to="/delivery" className="nav-link menu__link link-hover">
              Доставка і оплата
            </Link>
          </li>
          <li className="nav-item menu__li">
            <Link to="/contacts" className="nav-link menu__link link-hover">
              Контакти
            </Link>
          </li>
        </ul>
